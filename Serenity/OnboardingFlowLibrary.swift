//
//  OnboardingFlowLibrary.swift
//  Serenity
//
//  Alberature di onboarding predefinite
//

import Foundation

struct OnboardingFlowLibrary {
    static let commonQuestions: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "q0_gender",
    ...
    static let rootQuestion: OnboardingQuestion = {
        let opts = OnboardingReason.allCases.map { reason in
            OnboardingOption(id: reason.rawValue, title: reason.label)
        }
        return OnboardingQuestion(
            id: "q1_root",
            title: "Semplificando, perché sei qui oggi?",
            subtitle: "Puoi scegliere fino a 3 motivi",
            kind: .multiChoice(max: 3),
            options: opts
        )
    }()

    static let safetyQuestion = OnboardingQuestion(
        id: "safety_check",
    ...
    static func flow(for reason: OnboardingReason) -> [OnboardingQuestion] {
        switch reason {
        case .anxiety: return anxietyFlow
        case .sadness: return sadnessFlow
        case .parenting: return parentingFlow
        case .growth: return growthFlow
        case .relationship: return relationshipFlow
        case .genderIdentity: return genderFlow
        case .sexuality: return sexualityFlow
        case .lifeEvent: return lifeEventFlow
        case .workStudy: return workStudyFlow
        case .foodBody: return foodFlow
        case .other: return otherFlow
        }
    }

    // MARK: - Flussi

    private static let anxietyFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "a1_duration",
    ...
    private static let sadnessFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "b1_duration",
    ...
    private static let parentingFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "c1_age",
    ...
    private static let growthFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "d1_focus",
    ...
    private static let relationshipFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "e1_type",
    ...
    private static let genderFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "f1_stage",
    ...
    private static let sexualityFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "g1_focus",
    ...
    private static let lifeEventFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "h1_when",
        ...
        OnboardingQuestion(
            ...
            options: [
                ...
                OnboardingOption(id: "none", title: "Niente di tutto questo")
            ],
            reason: .lifeEvent
        )
    ]

    private static let workStudyFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "i1_context",
    ...
    private static let foodFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "j1_issue",
    ...
    private static let otherFlow: [OnboardingQuestion] = [
        OnboardingQuestion(
            id: "k1_free",
            title: "In poche parole, su cosa ti piacerebbe lavorare?",
            kind: .freeText(placeholder: "Scrivi una frase su ciò che ti porta qui"),
            reason: .other
        ),
        OnboardingQuestion(
            id: "k2_area",
